...
//  ===== BELOW - ADDING CRAFT_TYPE FROM hangar.php TO THE pilot_craft_type TABLE =============================
...
//  ===== ABOVE - ADDING CRAFT_TYPE FROM hangar.php TO THE pilot_craft_type TABLE =============================

// ================ CONTRACT SELECTION - Pilot Information in hangar.php =================
...
$(document).ready(function () {
	...
	$("#addContractBtn").unbind("click").click(function () {
		...
		if (hasText == '') {
			alert("To properly add you must have one select.  Otherwise can't run code");
			return;
		}

		$.ajax({
			type: "POST",
			url: "add_pilot_contract.php",
			data: {
				pilot_id: pilotId,
...
// 				data: {
// 					field: field,
// 					value: dateValue || null // Send null if dateValue is empty
// 				},
// 				success: function (response) {
