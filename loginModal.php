                ...
                <form action="signup.php" method="post" class="text-center" id="signUpForm">
                    <div class='step' data-step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="signup_account" class="form-control" name="account"
                                required="required" />
                        </div>
                        <div class="form-group">
                            <label for="nationality">Operation Nationality* <div class="fa fa-question-circle"
                                    data-toggle="tooltip" data-placement="left"
                                    title="Used in forms. ex: 'Angolan' Visa"></div></label>
                            <input type="text" id="signup_nationality" class="form-control" name="nationality" />
                        </div>
