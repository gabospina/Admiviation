...
if (!isset($_SESSION["HeliUser"])) {
	...
	// header("Location: http://localhost/admviation/home.php")
	...
	switch($page){
		...
		case "pilots":
			echo'
				...
				<script src="assets/lib/moment.min.js"></script>
			';
				// <script src="universalfunctions1.js"></script>
				// <script src="assets/js/loginfunctions1.js"></script>
		...
		case "contracts":
			...
			// IMPORTANT <script src="https://cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.1/spectrum.min.js" integrity="sha512-1aNp9qKP+hKU/VJwCtYqJP9tdZWbMDN5pEEXXoXT0pTAxZq1HHZhNBR/dtTNSrHO4U1FsFGGILbqG1O9nl8Mdg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
			// IMPORTANT <link type="text/css" rel="stylesheet" href="assets/css/spectrum.css">
