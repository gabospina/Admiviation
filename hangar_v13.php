                            ...
                            // if (in_array($adminLevel, array(0, 1, 2, 3, 8))) {
                                ...
                                echo    '</select>
                                        ...
                                        <select id="contractSelect">
                                            ...
                                            // Fetch contracts and customers to be added.
                                            $sql = "SELECT
                                            ...
                                            ORDER BY
                                                contracts.contract_name, customers.customer_name";

                                            $result = $mysqli->query($sql);

                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo '<option value="' . htmlspecialchars($row["contract_id"]) . '">' . htmlspecialchars($row["contract_name"]) . ' - ' . htmlspecialchars($row["customer_name"]) . '</option>';
                                                }
                                            } else {
