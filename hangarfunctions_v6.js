$(document).ready(function () {
	...
	$.ajax({
		...
		success: function (data) {
			...
			function savePersonalInfo(field, value, modalId) {
				$.ajax({
					type: "POST",
					...
					success: function (result) {
						if (result == "success") {
							showNotification("success", "Successfully updated " + field);
					...
					error: function () {
						showNotification("error", "An error occurred while updating " + field);
					}
				});
			}
			...
			$(".savePersonalInfo").click(function () {
				...
				var ang_license = $("#ang_license").val();
				...
				savePersonalInfo("fname", fname, "#personalInfoModal");
				savePersonalInfo("lname", lname, "#personalInfoModal");
				savePersonalInfo("username", username, "#personalInfoModal");
				savePersonalInfo("user_nationality", user_nationality, "#personalInfoModal");
				savePersonalInfo("comandante", comandante, "#personalInfoModal");
				savePersonalInfo("ang_license", ang_license, "#personalInfoModal");
				savePersonalInfo("for_license", for_license, "#personalInfoModal");
				savePersonalInfo("email", email, "#personalInfoModal");
				savePersonalInfo("phone", phone, "#personalInfoModal");
				savePersonalInfo("phonetwo", phonetwo, "#personalInfoModal");
			});

			$(".saveUsername").click(function () {
				var username = $("#usernameInput").val();
				savePersonalInfo("username", username, "#usernameModal");
			});
			$(".saveNationality").click(function () {
				var user_nationality = $("#user_nationality").val();
				savePersonalInfo("user_nationality", user_nationality, "#nationalityModal");
			});
