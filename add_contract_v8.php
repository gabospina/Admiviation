...
try {
    // Validate customer_id exists in the customers table
    ...
    if ($result_validate_customer->num_rows === 0) {
        throw new Exception("Invalid customer_id: The customer does not exist in the database.");
    }
    ...
    // Insert into contract_crafts table
    ...
    // Insert into contract_pilots table
    if (!empty($pilot_ids)) {
