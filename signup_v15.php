...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["ajax"])) {
    ...
    if ($company_stmt) {
        ...
        if ($company_stmt->execute()) {
            ...
            // Insert user data
            $user_sql = "INSERT INTO users (company_id, firstname, lastname, user_nationality, email, phone, username, password, role_id)
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1)"; // Assign role_id = 1 (pilot)
            ...
            if ($user_stmt) {
                ...
                if ($user_stmt->execute()) {
                    ...
                    $_SESSION["role_id"] = 1; // Set role_id to 1 (pilot)
