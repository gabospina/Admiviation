...
<div class="container inner-md">
    <div class="row">
      <h2 class="text-black text-center">Crafts</h2>
    </div>
    <!-- ================ BELOW - SEARCH input =================================== -->
    ...
    <div id="crafts"></div> <!-- Craft data loaded here -->
...
<!-- Define phpHeliUser and companyId -->
<script>
  var phpHeliUser = '<?php echo isset($_SESSION["HeliUser"]) ? htmlspecialchars($_SESSION["HeliUser"], ENT_QUOTES, 'UTF-8') : ''; ?>';
  var companyId = <?php echo json_encode($_SESSION['company_id']); ?>;
</script>

<!-- Include craftfunctions.js -->
