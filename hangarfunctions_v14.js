...
//  ===== BELOW - ADDING Pilot CRAFT_TYPE Selection hangar.php insert in pilot_craft_type TABLE =============================
...
// //  ===== ABOVE - ADD Pilot Select craft type hangar.php insert in pilot_craft_type TABLE =============================

// // ================ ADD Pilot Select Contract in hangar.php insert in contract_pilots TABLE =================
...
// 	console.log("The JS function loaded and ran by DEESEEK !!.");
// });
...
// 	// Validity Datepicker and Status Update
// 	function initDatepickers() {
// 		$('.datepicker').datepicker({
// 			dateFormat: 'yy-mm-dd',
// 			onSelect: function (dateText, inst) {
// 				$(this).val(dateText); // Update the input box with the selected date
// 				updateValidityStatus($(this));
// 			}
// 		});
// 	}

// 	function updateValidityStatus(dateInput) {
...
// 	// Initial Status Update on Page Load (for existing dates)
