...
$(document).ready(function () {
	...
	$("#uploadDocuments").dropzone({
		url: "change-profile-picture.php?pilot_id=",
		maxFilesize: 1.5,
		clickable: true,
			...
			if ([8, 7, 6, 3].indexOf(admin) != -1) {
				...
				$("#submitPilot").click(function (e) {
					...
					if (fname != "" && lname != "" && username != "" && validUsername && comandante != "") {
						...
						// ============ create_new_pilot.php ======================

						$(".addPilot").modal("hide");
						//TODO ADD LOADING MODAL
						$.ajax({
							type: "POST",
							url: "create_new_pilot.php",
...
// getPilot(id): Fetches detailed information for a specific pilot via AJAX and updates the UI.
		...
		success: function (data) {
			...
			if (admin > 0) {
				...
				$(".saveContractList").click(function () {
					...
					$.ajax({
						type: "POST",
						url: "update_pilot_contracts.php",
...
// ============== BELOW - pilot-sorting.js =================================================

// Sorts a list of elements alphabetically by name
...
// Sorts a list of elements by position.
...
// Sorts a list of elements by "On/Off Duty" status.
...
// Sorts a list of elements by creation date.
...
// ============== BELOW - pilot-filtering.js =================================================
// Filters the pilot list based on the selected craft type.
...
// ==============  - pilot-main.js =================================================
// Resets the pilot information section of the page.
...
// =============== pilot-event.php =======================================
// Updates the displayed pilot list based on filter criteria (managers, pilots, etc.) via AJAX.
...
$(document).ready(function () {
	...
	function updateClock() {
		...
		$('#localTime .timeVal').text(localTime);
	}
