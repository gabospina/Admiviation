...
// Ensure that session variables are properly set and are integers
$user_id = isset($_SESSION["HeliUser"]) ? (int)$_SESSION["HeliUser"] : 0;
$company_id = isset($_SESSION["company_id"]) ? (int)$_SESSION["company_id"] : 0;

// Output the user and company IDs to JavaScript variables
echo "<script>";
echo "var phpHeliUser = '" . htmlspecialchars($user_id, ENT_QUOTES, 'UTF-8') . "';";
// echo "var phpCompanyId = '" . htmlspecialchars($company_id, ENT_QUOTES, 'UTF-8') . "';";
echo "</script>";
...
<div class="light-bg" id="personalSection">
            ...
            echo '<div class="row inner-left-md inner-right-md">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Check Validities-hangar<small>Click on <u>date</u> to update</small>
    ...
    <div class="row inner-left-md inner-right-md">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="#" data-toggle="modal" data-target="#personalInfoModal">
                        <h3 class="panel-title">Personal Information-hangar  <small>(Click to edit)</small></h3>
                    </a>
                </div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <div id="craftTypeSection">
                            ...
                            <select id="contractSelect">
                                ...
                                <!-- Contracts will be loaded here by JavaScript -->
                            </select>
                            <button id="addContractBtn">+</button>
            ...
            // if (in_array($adminLevel, array(0, 1, 2, 3, 8))) {
                echo '<div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Duty Schedule-hangar</h3>
                            </div>
                            <div class="panel-body">
        ...
        <div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Certification Validity-hangar</h3>
    </div>
    <div class="panel-body">
